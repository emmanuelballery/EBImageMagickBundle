...
class ImageMagickTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$image = new Image(__DIR__ . '/../Resources/test/images/test.jpg');
    }
    ...
    {
        if (null !== $this->target && $this->target instanceof Image) {
    ...
    public function testConvert($format)
    {
        ...
        $this->assertTrue($this->target instanceof Image);
